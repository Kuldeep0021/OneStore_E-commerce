...
import { LayoutDashboard, Tag, ShoppingBag, Users, ShoppingCart, LogOut, Settings, Menu, X, Store } from 'lucide-react';
...
const AdminLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Store Info', path: '/admin/store-settings', icon: Store },
  ];
