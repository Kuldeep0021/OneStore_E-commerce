...
const RefundPolicy = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 min-h-screen">
      <h1 className="text-4xl font-serif text-brand-primary uppercase tracking-wider mb-8 text-center">Refund Policy</h1>
      ...
      <div className="space-y-8 text-gray-700 font-light leading-relaxed">
        <section>
          <h2 className="text-2xl font-serif text-brand-gold-dark mb-4">1. Return Window</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-brand-gold-dark mb-4">2. Non-returnable Items</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-brand-gold-dark mb-4">3. Refund Process</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-brand-gold-dark mb-4">4. Return Shipping</h2>
