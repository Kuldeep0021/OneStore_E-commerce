...
const TermsOfService = () => {
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 min-h-screen">
      <h1 className="text-4xl font-serif text-luora-primary uppercase tracking-wider mb-8 text-center">Terms of Service</h1>
      ...
      <div className="space-y-8 text-gray-700 font-light leading-relaxed">
        <section>
          <h2 className="text-2xl font-serif text-luora-gold-dark mb-4">1. Acceptance of Terms</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-luora-gold-dark mb-4">2. Online Store Terms</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-luora-gold-dark mb-4">3. Products or Services</h2>
        ...
        <section>
          <h2 className="text-2xl font-serif text-luora-gold-dark mb-4">4. Modifications to the Service and Prices</h2>
